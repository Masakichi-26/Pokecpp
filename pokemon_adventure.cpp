...
int main(){
	...
	std::cout << "�����O�͉��ł����H" << std::endl;
	std::string trainer_name{};
	getline(std::cin, trainer_name);
	Trainer t1 {trainer_name};
	std::cout << "�����O�́@" << t1.get_trainer_name() << "�ł��ˁB" << std::endl;
	std::cout << "�q�g�J�Q�������܂��B���킢�����Ă��������B" << std::endl;
...
//	t1.display_trainer_location();
	...
	for(int i = 0; i < p1.get_waza_current_size(); i++){
		...
		<< "�З́F" << std::setw(3) << std::right << p1.get_waza_current().at(i).get_waza_power() 
...
//	int enemy_level {};
	...
	*/
	...
	std::cout << std::endl;
	Waza w1 {"����������"};
	std::cout << "�킴��: " << w1.get_waza_name() << std::endl;
	std::cout << "�З́@: " << w1.get_waza_power() << std::endl;
	std::cout << "������: " << w1.get_waza_accuracy() << std::endl;
	*/
